...

{
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/FTNmX1PU8/model.json",modelReady);
}
function modelReady()
{
...
if(error) {
    ...
    if(result[0].label == "T-rex roar"){
        img1.src ="T-Rex.png";
        
    } else if (result[0].label == "Prusten"){
        img1.src ="Tiger.jpg"
